<x-app-layout>
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-10">
                ...
                <!-- Product Info Card -->
                <div
                    class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-6 mb-8">
                    <div class="flex items-center">
                        <div
                            class="p-4 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl shadow-lg mr-6">
            ...
            <!-- FORM UTAMA (UPDATE PRODUK + UPLOAD GAMBAR) -->
            <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                <div class="px-8 py-6 border-b border-gray-200 bg-gray-50">
                    <h2 class="text-xl font-semibold text-gray-900">Informasi Produk</h2>
                    <p class="text-sm text-gray-500 mt-1">Update detail produk dan gambar</p>
                </div>
                ...
                <form method="POST"
                            ...
                            <div class="relative">
                                ...
                                <select name="product_category_id"
                                    ...
                                    @foreach($categories as $cat)
                                        <option value="{{ $cat->id }}"
                                            {{ old('category_id', $product->product_category_id ?? $product->category_id) == $cat->id ? 'selected' : '' }}>
                                            {{ $cat->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mt-8">
                                ...
                                <textarea name="description"
                                          ...
                                          class="block w-full px-4 py-3 border border-gray-300 rounded-lg
                                                 ...
                                                 placeholder-gray-400">{{ old('description', $product->description ?? '') }}</textarea>
                                <p class="mt-2 text-sm text-gray-500">
                                    Deskripsi membantu pelanggan memahami produk Anda dengan lebih baik.
                                </p>
                            </div>
                        </div>

                        {{-- Gambar Produk - DALAM FORM YANG SAMA --}}
                        <div class="border-t border-gray-200 pt-8">
                            ...
                            <p class="text-sm text-gray-600 mb-3">
                                Pilih foto baru untuk menambahkan ke galeri produk. Foto lama tidak akan hilang
                                kecuali kamu hapus di bawah.
                            </p>
                            ...
                            <div id="editUploadBox"
                                ...
                                <p class="text-gray-600 mb-2">Drag & drop atau klik untuk upload gambar baru</p>
                                <p class="text-sm text-gray-500 mb-4">
                                    Format: JPG, PNG, GIF (Maks 5MB per gambar) – Maksimal 8 gambar total
                                </p>
                            ...
                            <div class="mt-6">
                                ...
                                <p class="mt-3 text-xs text-gray-500">
                                    Gambar di atas hanya preview sebelum disimpan. Setelah klik "Simpan Perubahan",
                                    gambar akan ditambahkan ke galeri produk.
                                </p>
                            </div>
                    ...
                    {{-- TOMBOL AKSI --}}
                    <div
                        class="mt-12 pt-8 border-t border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {{-- KARTU GAMBAR LAMA (DI LUAR FORM) --}}
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden mt-10">
                ...
                <div class="p-6">
                    ...
                    @else
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            @foreach ($product->productImages as $img)
                                <div class="relative border rounded-xl overflow-hidden bg-gray-50">
                                    ...
                                    <form action="{{ route('seller.products.images.delete', $img->id) }}"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                                class="bg-red-500/90 hover:bg-red-600 text-white text-xs px-2 py-1 rounded shadow">
                                            Hapus
                                        </button>
                                    </form>
                                </div>
                    ...
                    <p class="mt-4 text-xs text-gray-500">
                        Menghapus gambar di sini tidak mempengaruhi detail produk lainnya.
                    </p>
                </div>
            </div>
                        ...
                        <div>
                            ...
                            <ul class="space-y-2 text-sm text-gray-700">
                                <li class="flex items-start">
                                    <svg class="w-4 h-4 text-blue-500 mt-0.5 mr-2 flex-shrink-0"
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-700">
                                Semua perubahan yang Anda simpan akan dicatat dalam sistem. Data produk Anda
                                terlindungi dengan enkripsi tingkat tinggi.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        if (editUploadBox) {
            editUploadBox.addEventListener('click', () => editInput.click());
        }
        if (editUploadButton) {
            editUploadButton.addEventListener('click', () => editInput.click());
        }
        ...
        if (editInput) {
            editInput.addEventListener('change', () => {
                ...
                [...editInput.files].forEach((file, index) => {
                    const reader = new FileReader();

                    reader.onload = (e) => {
                        const label = index === 0 ? 'Thumbnail (baru)' : 'Gambar ' + (index + 1);
                        editPreviewContainer.innerHTML += `
